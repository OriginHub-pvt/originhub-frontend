  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'Hello! I\'m your AI startup ideation assistant. Share a real-world problem you\'ve encountered, and I\'ll help you transform it into a viable startup idea. What problem would you like to explore?',
      timestamp: new Date(),
    },
  ]);
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        {/* Chat Header */}
        <div className="border-b border-slate-200 bg-white px-4 py-4 shadow-sm sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Share a problem to get started</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Input Area */}
        <div className="border-t border-slate-200 bg-white px-4 py-4 shadow-lg sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            <div className="flex items-end space-x-4">
              <div className="flex-1 rounded-xl border-2 border-slate-200 bg-slate-50 focus-within:border-[#14b8a6] focus-within:bg-white transition-colors">
                <textarea
                  ref={inputRef}
                  value={input}
                  ...
                  rows={1}
                  className="w-full resize-none rounded-xl bg-transparent px-4 py-3 text-sm text-slate-900 placeholder-slate-400 focus:outline-none sm:text-base"
                  style={{
                    maxHeight: '120px',
                    minHeight: '48px',
                  }}
